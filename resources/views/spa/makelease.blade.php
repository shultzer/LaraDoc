                ...
                <form class="form-horizontal" method="post" action="{{ route('make_lease_letter') }}"
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="radio">
                                    <span class="checked"><input type="radio" name="mov" value="nomovable"
                                                                 class="radio"></span>
                                    недвижимое
                                </label>
                                <div style="clear:both"></div>
                                <label class="radio">
                                    <span class="checked"><input type="radio" name="mov" value="movable"
                                                                 class="radio"></span>
                                   движимое
                                </label>
                                <div style="clear:both"></div>
                                <label class="radio">
                                    <span class="checked"><input type="radio" name="mov" value="mixed"
                                                                 class="radio"></span>
                                    смешанное
                                </label>
                                <div style="clear:both"></div>
                                <label class="radio">
                                    <span class="checked"><input type="radio" name="mov" value="vehicle"
                                                                 class="radio"></span>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <div style="clear:both"></div>
                                <label class="radio">
                                    <span class="checked"><input type="radio" name="type" value="payfree" class="radio"></span>
                                    смешанное
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="control-group" id="advert" {{--style="display: none"--}}>
                            <label class="control-label">Объявление в интернет</label>
                            <div class="controls">
                                <label class="radio">
                                    <span class="checked"><input type="checkbox" name="advert" value="pay"
                                                                 class="radio"></span>
                                </label>
                                <div style="clear:both"></div>
